...
# Questions can be asked like below to assistant
...
# But, we can also ask the assistant questions that it shouldn’t be able to answer, 
# because it hasn’t been given any data that is relevant to the question:
#
